...
class UI {
	...
	//inicio del filtrado de productos
	detalleProducto(id){
			...
			<article class="detalle-grid">
				...
				<div class="detalles-content">
					...
					<div class="rating">
						...
						<p class="description">
							<b>Descripcion: </b> <span>Lorem ipsum dolor sit amet consectetur 
							adipisicing elit. Soluta quae ad ex sint expedita perspiciatis odit 
							eligendi! Et quia ex aperiam dolorum sunt omnis maiores. Repudiandae 
							delectus iste exercitationem vel?</span>
						</p>
						<p class="description">
...
// fin del filtrado de los servicios
